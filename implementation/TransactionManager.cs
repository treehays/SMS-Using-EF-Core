...
{
    public int I = 0;
    private static readonly String ConnString = "SERVER=localhost; User Id=root; Password=1234; DATABASE=sms";
    ...
    public void CreateTransaction(string staffId, string barCode, int quantity, string customerId, decimal cashTender)
    {
        ...
        {
            new Transaction(receiptNo, barCode, quantity, total, customerId, dateTime, cashTender);
            try
            {
