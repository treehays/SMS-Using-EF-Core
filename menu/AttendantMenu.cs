...
public class AttendantMenu
{
    ...
    public void RegisterAttendantPage()
    {
        ...
        var attendantCheck = _iAttendantManager.GetAttendant(email);
        if (attendantCheck == null)
        {
            ...
            _iAttendantManager.CreateAttendant(attendant);
    ...
    private void UpdateAttendantPassword(Attendant attendant)
    {
        ...
        if (attendant.Pin == pin)
        {
            ...
            _iAttendantManager.UpdateAttendantPassword(attendant, pin);
            AttendantSubMenu(attendant);
        }
        else
        {
